...
const PaperType = () => {
    return (
<div>
<h1 class="text-5xl font-bold text-center text-white mt-20">Categories</h1>
...
<SinglePaper bgClass="bg-base-100" paperTitle="Thesis" paperDetails="Button to listen on app." img={icon1}></SinglePaper>       
 </div>
</div>
    );
